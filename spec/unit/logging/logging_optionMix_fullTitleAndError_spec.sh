...
Describe "Log:" logging
	Describe "logging():" logging:logging
		...
		Describe "Option mix:" loggingLog:optionMix
			Describe "--full-title and error:" loggingLogUtilOptionMix:fullTitleAndError
				output() {
				...
				It "--error" loggingLogUtilOptionMixFullTitleAndError:error
				...
				End
				It "-e" loggingLogUtilOptionMixFullTitleAndError:e

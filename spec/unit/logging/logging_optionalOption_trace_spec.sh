...
Describe "Log:" logging
	Describe "logging():" logging:logging
		...
		Describe "Optional option:" loggingLog:optionalOption
			Describe "Trace:" loggingLogOptionalOption:trace
				It "None" loggingLogOptionalOptionTrace:none
				...
				End
				It "-t" loggingLogOptionalOptionTrace:t
					...
					The status should be success
				End
				It "--trace" loggingLogOptionalOptionTrace:trace

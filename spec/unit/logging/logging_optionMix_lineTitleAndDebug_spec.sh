...
Describe "Logging:" logging
	Describe "logging():" logging:logging
		...
		Describe "Option mix:" loggingLogging:optionMix
			Describe "--line-title and debug:" loggingLoggingUtilOptionMix:lineTitleAndDebug
				output() {
				...
				It "--debug" loggingLoggingUtilOptionMixLineTitleAndDebug:debug
				...
				End
				It "-d" loggingLoggingUtilOptionMixLineTitleAndDebug:d
